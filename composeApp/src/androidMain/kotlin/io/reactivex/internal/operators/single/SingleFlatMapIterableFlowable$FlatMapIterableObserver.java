...
final class SingleFlatMapIterableFlowableFlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
    ...
    SingleFlatMapIterableFlowableFlatMapIterableObserver(Subscriber<? super R> subscriber, Function<? super T, ? extends Iterable<? extends R>> function) {
