...
public enum zza {
    ...
    /*  WARNING: Code restructure failed: missing block: B:9:0x0025, code lost:
    ...
    public static PendingIntent zza(final Context context, final int i2, final Intent intent, final int i3) {
