...
public class BottomSheetDragHandleView extends AppCompatImageView implements AccessibilityManager.AccessibilityStateChangeListener {
    ...
    /*  WARN: Type inference failed for: r2v0, types: [com.google.android.material.bottomsheet.BottomSheetDragHandleView] */
    /*  WARN: Type inference failed for: r2v1, types: [android.view.View] */
    /*  WARN: Type inference failed for: r2v2, types: [android.view.View] */
    @Nullable
