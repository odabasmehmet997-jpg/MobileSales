...
public final class CameraManager {
    ...
    private int calculateDisplayRotation() {
        ...
        if (cameraInfo.facing == 1) {
            r4 = (360 - ((cameraInfo.orientation + r2) % 360)) % 360;
        } else {
            r4 = ((cameraInfo.orientation - r2) + 360) % 360;
        }
        Log.i(TAG, "Camera Display Orientation: " + r4);
        return r4;
    }

    private void setCameraDisplayOrientation(int r1) {
        this.camera.setDisplayOrientation(r1);
    }

    private void setParameters() {
        try {
            int r0 = calculateDisplayRotation();
            this.rotationDegrees = r0;
