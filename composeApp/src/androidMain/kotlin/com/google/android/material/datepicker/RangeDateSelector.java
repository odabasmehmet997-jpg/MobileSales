...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public boolean isSelectionComplete() {
        Long l = this.selectedStartItem;
        return l != null && this.selectedEndItem != null && isValidRange(l.longValue(), this.selectedEndItem.longValue());
    }
    ...
    public int getDefaultThemeResId(@NonNull Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, i2, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        final TextInputLayout textInputLayout = viewInflate.findViewById(R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = viewInflate.findViewById(R.id.mtrl_picker_text_input_range_end);
