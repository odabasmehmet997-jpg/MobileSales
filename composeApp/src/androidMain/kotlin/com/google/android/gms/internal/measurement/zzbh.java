...
public final class zzbh extends zzaw {
    ...
    private static zzap zzc(zzbf zzbf, Iterator it, zzap zzap) {
        if (null != it) {
            while (it.hasNext()) {
                ...
                if (zzc instanceof final zzag zzag) {
    ...
    public zzap zza(String str, zzg zzg, List list) {
        ...
        if (65 != ordinal) {
            switch (ordinal) {
                case 26:
                    zzh.zzh(com.google.android.gms.internal.measurement.zzbl.FOR_IN.name(), 3, list);
                ...
                case 29:
                    ...
                    if (zzb instanceof final zzae zzae) {
                        ...
                        while (zzg.zzb(zzap).zzg().booleanValue()) {
                            ...
                            zzg zza2 = zzg.zza();
                            for (int i3 = 0; i3 < zzae.zzc(); i3++) {
                                String zzi2 = zzae.zze(i3).zzi();
                ...
                case 30:
                    zzh.zzh(com.google.android.gms.internal.measurement.zzbl.FOR_OF.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zze(new zzbg(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF must be a string");
                case 31:
                    zzh.zzh(com.google.android.gms.internal.measurement.zzbl.FOR_OF_CONST.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zze(new zzbd(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF_CONST must be a string");
                case 32:
                    zzh.zzh(com.google.android.gms.internal.measurement.zzbl.FOR_OF_LET.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
            ...
            zzh.zzh(com.google.android.gms.internal.measurement.zzbl.WHILE.name(), 4, list);
            ...
            if (zzg.zzb((zzap) list.get(2)).zzg().booleanValue()) {
                ...
                if (zzc2 instanceof final zzag zzag2) {
            ...
            while (zzg.zzb(zzap3).zzg().booleanValue()) {
                ...
                if (zzc3 instanceof final zzag zzag3) {
