...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public MaterialCheckBox(Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialCheckBox, i2, i3);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i4)) {
            setCheckedState(tintTypedArrayObtainTintedStyledAttributes.getInt(i4, 0));
        }
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        ...
        if (this.usingMaterialButtonDrawable) {
            ...
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(R.id.indeterminate, i3, this.transitionToUnchecked, false);
        }
    }
