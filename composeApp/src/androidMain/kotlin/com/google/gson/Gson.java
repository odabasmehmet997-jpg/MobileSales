...
public final class Gson {
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
    ...
    if (null != cached) {
      @SuppressWarnings("unchecked") TypeAdapter<T> adapter = (TypeAdapter<T>) cached;
      return adapter;
    }
  ...
  public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
    @SuppressWarnings("unchecked") TypeAdapter<Object> adapter = (TypeAdapter<Object>) getAdapter(TypeToken.get(typeOfSrc));

    Strictness oldStrictness = writer.getStrictness();
    if (null != strictness) {
      writer.setStrictness(this.strictness);
    } else if (Strictness.LEGACY_STRICT == writer.getStrictness()) {
  ...
  public JsonWriter newJsonWriter(Writer writer) throws IOException {
    ...
    jsonWriter.setStrictness(null == this.strictness ? Strictness.LEGACY_STRICT : strictness);
  ...
  public JsonReader newJsonReader(Reader reader) {
    ...
    jsonReader.setStrictness(null == this.strictness ? Strictness.LEGACY_STRICT : strictness);
    return jsonReader;
  }
  ...
  public <T> T fromJson(JsonReader reader, TypeToken<T> typeOfT)
    ...
    } else if (Strictness.LEGACY_STRICT == reader.getStrictness()) {
    ...
    try {
      ...
      if (null != object && !expectedTypeWrapped.isInstance(object)) {
  ...
  private static void assertFullConsumption(Object obj, JsonReader reader) {
    try {
      if (null != obj && JsonToken.END_DOCUMENT != reader.peek()) {
