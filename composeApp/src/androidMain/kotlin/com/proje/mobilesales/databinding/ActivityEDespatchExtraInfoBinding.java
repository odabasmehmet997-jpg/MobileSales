...
public final class ActivityEDespatchExtraInfoBinding implements ViewBinding {
    ...
    public static ActivityEDespatchExtraInfoBinding inflate( final LayoutInflater layoutInflater) {
        return ActivityEDespatchExtraInfoBinding.inflate(layoutInflater, null, false);
    }
    public static ActivityEDespatchExtraInfoBinding inflate( final LayoutInflater layoutInflater,  final ViewGroup viewGroup, final boolean z) {
        final View inflate = layoutInflater.inflate(R.layout.activity_e_despatch_extra_info, viewGroup, false);
        if (z) {
            viewGroup.addView(inflate);
        }
        return ActivityEDespatchExtraInfoBinding.bind(inflate);
    }
    public static ActivityEDespatchExtraInfoBinding bind( final View view) {
