...
final class zzas implements StreetViewLifecycleDelegate {
    ...
    public zzas(final ViewGroup viewGroup, final IStreetViewPanoramaViewDelegate iStreetViewPanoramaViewDelegate) {
        zzb = Preconditions.checkNotNull(iStreetViewPanoramaViewDelegate);
    ...
    public void getStreetViewPanoramaAsync(final OnStreetViewPanoramaReadyCallback onStreetViewPanoramaReadyCallback) {
        try {
            zzb.getStreetViewPanoramaAsync(new zzar(this, onStreetViewPanoramaReadyCallback));
