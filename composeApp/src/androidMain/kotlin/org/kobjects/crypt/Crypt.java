...
public class Crypt {
    ...
    private static int HPERM_OP(int i2, int i3, int i4) {
        int i5 = 16 - i3;
        int i6 = i4 & ((i2 << i5) ^ i2);
        return (i2 ^ i6) ^ (i6 >>> i5);
    }
    ...
    private static int fourBytesToInt(byte[] bArr, int i2) {
        int iByteToUnsigned = (byteToUnsigned(bArr[i2 + 1]) << 8) | byteToUnsigned(bArr[i2]);
        return (byteToUnsigned(bArr[i2 + 3]) << 24) | iByteToUnsigned | (byteToUnsigned(bArr[i2 + 2]) << 16);
    }
    ...
    private static void PERM_OP(int i2, int i3, int i4, int i5, int[] iArr) {
        int i6 = i5 & ((i2 >>> i4) ^ i3);
        iArr[0] = i2 ^ (i6 << i4);
        iArr[1] = i3 ^ i6;
    }
    private static int[] des_set_key(byte[] bArr) {
        ...
        while (i9 < 16) {
            ...
            int i11 = i4 | i3;
            int i12 = i2 & 268435455;
            int i13 = i11 & 268435455;
            int[][] iArr3 = skb;
            int i14 = iArr3[0][i2 & 63] | iArr3[1][((i12 >>> 6) & 3) | ((i12 >>> 7) & 60)] | iArr3[2][((i12 >>> 13) & 15) | ((i12 >>> 14) & 48)] | iArr3[3][((i12 >>> 20) & 1) | ((i12 >>> 21) & 6) | ((i12 >>> 22) & 56)];
    ...
    private static int D_ENCRYPT(int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        int i7 = (i3 >>> 16) ^ i3;
        int i8 = i5 & i7;
        int i9 = i6 & i7;
    ...
    private static int[] body(int[] iArr, int i2, int i3) {
        ...
        while (i4 < 25) {
            ...
            for (int i6 = 0; i6 < 32; i6 += 4) {
                int i7 = iD_ENCRYPT;
                iD_ENCRYPT2 = D_ENCRYPT(iD_ENCRYPT2, i7, i6, i2, i3, iArr);
                iD_ENCRYPT = D_ENCRYPT(i7, iD_ENCRYPT2, i6 + 2, i2, i3, iArr);
            }
            i4++;
            i5 = iD_ENCRYPT;
        ...
        int[] iArr2 = new int[2];
        PERM_OP((i5 >>> 1) | (i5 << 31), (iD_ENCRYPT >>> 1) | (iD_ENCRYPT << 31), 1, 1431655765, iArr2);
        PERM_OP(iArr2[1], iArr2[0], 8, 16711935, iArr2);
    ...
    public static String crypt(String str, String str2) {
        ...
        int[] iArr = con_salt;
        int i3 = iArr[cCharAt];
        int i4 = iArr[cCharAt2] << 4;
        byte[] bArr = new byte[8];
        for (int i5 = 0; i5 < 8; i5++) {
            bArr[i5] = 0;
        }
        for (int i6 = 0; i6 < 8 && i6 < str2.length(); i6++) {
            bArr[i6] = (byte) (str2.charAt(i6) << 1);
        }
        int[] iArrBody = body(des_set_key(bArr), i3, i4);
        ...
        for (i2 = 2; i2 < 13; i2++) {
            ...
            for (int i10 = 0; i10 < 6; i10++) {
                ...
                stringBuffer.setCharAt(i2, (char) cov_2char[i9]);
            }
        }
