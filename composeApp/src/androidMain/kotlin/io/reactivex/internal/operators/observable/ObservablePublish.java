...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements ObservablePublishClassic<T> {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (null != publishObserver && !publishObserver.isDisposed()) {
                break;
            }
            PublishObserver<T> publishObserver2 = new PublishObserver<>(this.current);
            if (LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.current, publishObserver, publishObserver2)) {
                publishObserver = publishObserver2;
                break;
            }
        }
        final boolean z = !publishObserver.shouldConnect.get () && publishObserver.shouldConnect.compareAndSet (false, true);
        try {
        ...
        public Disposable subscribe(Observer<DataResponse<ItemSlip>> observer) {
            ...
            while (true) {
                ...
                if (null == publishObserver || publishObserver.isDisposed()) {
                    ...
                    if (LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.curr, publishObserver, publishObserver2)) {
                        publishObserver = publishObserver2;
                    } else {
                        continue;
                    }
