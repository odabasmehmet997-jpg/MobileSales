...
class CrashlyticsController {
    ...
    void enableExceptionHandling(String str, Thread.UncaughtExceptionHandler uncaughtExceptionHandler, SettingsDataProvider settingsDataProvider) {
        openSession(str);
    ...
    /*  INFO: renamed from: com.google.firebase.crashlytics.internal.common.CrashlyticsController$4, reason: invalid class name */
    ...
    void writeToLog(final long j2, final String str) {
    ...
    void writeNonFatalException(@NonNull final Thread thread, @NonNull final Throwable th) {
        final long jCurrentTimeMillis = System.currentTimeMillis();
