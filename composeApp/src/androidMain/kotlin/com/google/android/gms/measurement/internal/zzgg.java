...
record zzgg(zzgl zzc, zzau zza, String zzb) implements Callable {
        ...
        if (!zzr.zzs.zzf().zzs(str2, zzdw.zzS)) {
            ...
            if (null == zzj) {
                ...
                if (!TextUtils.isEmpty(zzj.zzv())) {
                    zzu.zzC(Preconditions.checkNotNull(zzj.zzv()));
                }
                if (!TextUtils.isEmpty(zzj.zzw())) {
                    zzu.zzD(Preconditions.checkNotNull(zzj.zzw()));
                }
                if (-2147483648L != zzj.zzb()) {
                    zzu.zzE((int) zzj.zzb());
                }
                zzu.zzR(zzj.zzm());
                zzu.zzM(zzj.zzk());
                ...
                if (zzh.zzi(zzag.AD_STORAGE)) {
                    ...
                    if (zzj.zzag() && !TextUtils.isEmpty((CharSequence) zzd.first)) {
                        try {
                            zzu.zzaa(zzid.zza((String) zzd.first, Long.toString(zzau.zzd)));
                ...
                try {
                    if (zzh.zzi(zzag.ANALYTICS_STORAGE) && null != zzj.zzu()) {
                        zzu.zzB(zzid.zza(Preconditions.checkNotNull(zzj.zzu()), Long.toString(zzau.zzd)));
                    }
                    if (!TextUtils.isEmpty(zzj.zzx())) {
                        zzu.zzP(Preconditions.checkNotNull(zzj.zzx()));
                    }
                    String zzt = zzj.zzt();
                    ...
                    if (null == zzkw || null == zzkw.zze()) {
                        zzkw zzkw2 = new zzkw(zzt, "auto", "_lte", zzr.zzs.zzav().currentTimeMillis(), 0L);
                        zzu2.add(zzkw2);
                        zzr.zzf.zzi().zzL(zzkw2);
                    }
                    ...
                    if (zzu3.zzs.zzg().zze()) {
                        ...
                        if (zzj.zzag() && zzu3.zzf.zzo().zzk(zzt2)) {
                            ...
                            while (true) {
                                if (!it2.hasNext()) {
                                    break;
                                } else if ("_npa".equals(((zzkw) it2.next()).zzc())) {
                                    it2.remove();
                                    break;
                                }
                            }
                    ...
                    for (int i2 = 0; i2 < zzu2.size(); i2++) {
                        com.google.android.gms.internal.measurement.zzgg zzd2 = zzgh.zzd();
                        zzd2.zzf(((zzkw) zzu2.get(i2)).zzc());
                        zzd2.zzg(((zzkw) zzu2.get(i2)).zzd());
                        zzr.zzf.zzu().zzu(zzd2, ((zzkw) zzu2.get(i2)).zze());
                        zzghArr[i2] = (zzgh) zzd2.zzay();
                    }
                    zzu.zzi(Arrays.asList(zzghArr));
                    zzek zzb2 = zzek.zzb(zzau);
                    ...
                    if (null == zzn) {
                        ...
                        bundle = bundle2;
                        obj = null;
                        zzaq = new zzaq(str2, zzau.zza, 0, 0, 0, zzau.zzd, 0, null, null, null, null);
                        j2 = 0;
                    } else {
                        zzg = zzj;
                        zzfv = zza2;
                    ...
                    zzap zzap = new zzap(zzr.zzs, zzau.zzc, str, zzau.zza, zzau.zzd, j2, bundle);
                    zzfn zze = zzfo.zze();
                    zze.zzm(zzap.zzd);
                    zze.zzi(zzap.zzb);
                    zze.zzl(zzap.zze);
                    ...
                    zzr.zzf.zzi().zzx();
                    try {
                        return zzr.zzf.zzu().zzy(zzfv2.zzay().zzbq());
                    } catch (IOException e3) {
                        zzr.zzs.zzay().zzd().zzc("Data loss. Failed to bundle and serialize. appId", zzej.zzn(str), e3);
                        return obj;
                    }
