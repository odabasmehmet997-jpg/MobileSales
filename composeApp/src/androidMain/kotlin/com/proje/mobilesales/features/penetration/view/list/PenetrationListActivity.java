...
public final class PenetrationListActivity extends BaseFicheListActivity {
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (intent.hasExtra("query")) {
            ...
            PenetrationListFragment penetrationListFragment = (PenetrationListFragment) getSupportFragmentManager().findFragmentByTag(BaseListActivity.LIST_FRAGMENT_TAG);
            if (penetrationListFragment != null) {
                penetrationListFragment.filter(this.mFilter);
            }
        }
    }
    ...
    public String getDefaultTitle() {
        String string = getString(R.string.activity_title_penetration_list);
    ...
    public Fragment instantiateListFragment() {
        ...
        Fragment instantiate = Fragment.instantiate(this, PenetrationListFragment.class.getName(), bundle);
