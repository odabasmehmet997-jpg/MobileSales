...
public final class CabinListActivity extends BaseFicheListActivity {
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        if (intent.hasExtra("query")) {
            ...
            final CabinListFragment cabinListFragment = (CabinListFragment) this.getSupportFragmentManager().findFragmentByTag(LIST_FRAGMENT_TAG);
            if (null != cabinListFragment) {
                cabinListFragment.filter(mFilter);
            }
        }
    }
    ...
    protected Fragment instantiateListFragment() {
        ...
        final Fragment instantiate = Fragment.instantiate(this, CabinListFragment.class.getName(), bundle);
