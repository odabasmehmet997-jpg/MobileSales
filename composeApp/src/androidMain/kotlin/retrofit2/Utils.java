...
final class Utils {
    ...
    static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType parameterizedType) {
            if (!(type2 instanceof ParameterizedType parameterizedType2)) {
                return false;
            }
            Type ownerType = parameterizedType.getOwnerType();
            Type ownerType2 = parameterizedType2.getOwnerType();
            return (Objects.equals(ownerType, ownerType2)) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType.getActualTypeArguments(), parameterizedType2.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
        ...
        if (type instanceof WildcardType wildcardType) {
            if (!(type2 instanceof WildcardType wildcardType2)) {
                return false;
            }
            return Arrays.equals(wildcardType.getUpperBounds(), wildcardType2.getUpperBounds()) && Arrays.equals(wildcardType.getLowerBounds(), wildcardType2.getLowerBounds());
        }
        if (!(type instanceof TypeVariable typeVariable) || !(type2 instanceof TypeVariable typeVariable2)) {
            return false;
        }
    ...
    static Type resolve(Type type, Class<?> cls, Type type2) {
        Type type3 = type2;
        while (type3 instanceof TypeVariable typeVariable) {
        ...
        if (type3 instanceof Class cls2) {
            if (cls2.isArray()) {
        ...
        if (type3 instanceof ParameterizedType parameterizedType) {
            Type ownerType = parameterizedType.getOwnerType();
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            this.ownerType = type;
            this.rawType = type2;
            this.typeArguments = typeArr.clone();
        }
