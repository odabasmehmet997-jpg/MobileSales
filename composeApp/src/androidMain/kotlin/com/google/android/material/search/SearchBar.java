...
public class SearchBar extends Toolbar {
    ...
    public SearchBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.SearchBar, i2, i3);
        ...
        this.textView = findViewById(R.id.open_search_bar_text_view);
    ...
    private Drawable maybeTintNavigationIcon(@Nullable Drawable drawable) {
        ...
        if (num != null) {
            ...
            color = MaterialColors.getColor(this, i2);
        }
