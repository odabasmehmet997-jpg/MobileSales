...
final class zzaz extends DeferredLifecycleHelper {
    ...
    @VisibleForTesting
    zzaz(final Fragment fragment) {
        zzb = fragment;
    }

    static void zza(final zzaz zzaz, final Activity activity) {
        zzaz.zzc = activity;
        zzaz.zzc();
    }
    ...
    public void zzc() {
        if (null != this.zzc && null != this.zza && null == getDelegate()) {
            try {
                ...
                zza.onDelegateCreated(new zzay(zzb, zzcc.zza(zzc, (MapsInitializer.Renderer) null).zzh(ObjectWrapper.wrap(zzc))));
                for (final OnStreetViewPanoramaReadyCallback streetViewPanoramaAsync : zzd) {
                    ((zzay) this.getDelegate()).getStreetViewPanoramaAsync(streetViewPanoramaAsync);
                }
                zzd.clear();
