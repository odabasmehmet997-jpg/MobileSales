...
public class DataFlavor implements Externalizable, Cloneable {
    ...
    public DataFlavor(Class<?> cls, String str) {
        ...
        mimeType.addParameter(Name.LABEL, cls.getName());
    ...
    public DataFlavor(String str, String str2) {
        try {
            ...
            throw new IllegalArgumentException(Messages.getString("awt.16C", this.mimeInfo.getParameter(Name.LABEL)), e2);
        }
    }
    ...
    private void init(String str, String str2, ClassLoader classLoader) throws ClassNotFoundException {
        ...
        try {
            ...
            if (str2 != null) {
                ...
                this.humanPresentableName = String.valueOf(parse.getPrimaryType()) + '/' + parse.getSubType();
            }
            String parameter = this.mimeInfo.getParameter(Name.LABEL);
            if (parameter == null) {
                this.mimeInfo.addParameter(Name.LABEL, "java.io.InputStream");
    ...
    public synchronized void readExternal(ObjectInput objectInput) throws IOException, ClassNotFoundException {
        try {
            ...
            this.mimeInfo = mimeType;
            this.representationClass = mimeType != null ? Class.forName(mimeType.getParameter(Name.LABEL)) : null;
        } catch (Throwable th) {
            throw th;
        }
    }
    ...
    public Reader getReaderForText(Transferable transferable) throws UnsupportedFlavorException, IOException {
        ...
        } else if (transferData instanceof Reader reader) {
            reader.reset();
            return reader;
