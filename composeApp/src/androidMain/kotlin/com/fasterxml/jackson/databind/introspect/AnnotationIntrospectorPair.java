...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable {
    ...
    public JsonIgnoreProperties.Value findPropertyIgnoralByName(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonIgnoreProperties.Value valueFindPropertyIgnoralByName = this._secondary.findPropertyIgnoralByName(mapperConfig, annotated);
        JsonIgnoreProperties.Value valueFindPropertyIgnoralByName2 = this._primary.findPropertyIgnoralByName(mapperConfig, annotated);
    ...
    public JsonIncludeProperties.Value findPropertyInclusionByName(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonIncludeProperties.Value valueFindPropertyInclusionByName = this._secondary.findPropertyInclusionByName(mapperConfig, annotated);
        JsonIncludeProperties.Value valueFindPropertyInclusionByName2 = this._primary.findPropertyInclusionByName(mapperConfig, annotated);
    ...
    public String findTypeName(AnnotatedClass annotatedClass) {
        ...
        return (strFindTypeName == null || strFindTypeName.isEmpty()) ? this._secondary.findTypeName(annotatedClass) : strFindTypeName;
    }
    ...
    public Boolean hasAsKey(MapperConfig<?> mapperConfig, Annotated annotated) {
        Boolean boolHasAsKey = this._primary.hasAsKey(mapperConfig, annotated);
        return boolHasAsKey == null ? this._secondary.hasAsKey(mapperConfig, annotated) : boolHasAsKey;
    }
