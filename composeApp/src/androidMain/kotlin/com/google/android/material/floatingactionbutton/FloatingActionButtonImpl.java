...
class FloatingActionButtonImpl {
    ...
    void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int i2) {
        ...
        this.contentBackground = new LayerDrawable(new Drawable[]{Preconditions.checkNotNull(this.shapeDrawable), rippleDrawableCompat});
    }
    ...
    /*  INFO: renamed from: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl$5, reason: invalid class name */
    class AnonymousClass5 implements TypeEvaluator<Float> {
        ...
        public Float evaluate(float f2, Float f3, Float f4) {
            float fFloatValue = this.floatEvaluator.evaluate(f2, f3, f4).floatValue();
            if (fFloatValue < 0.1f) {
                fFloatValue = 0.0f;
            }
