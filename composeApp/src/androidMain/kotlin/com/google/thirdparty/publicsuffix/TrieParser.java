...
final class TrieParser {
    ...
    static ImmutableMap<String, PublicSuffixType> parseFullString(String str) {
        ...
        int i2 = 0;
        while (i2 < length) {
            i2 += doParseTrieToBuilder(Queues.newArrayDeque(), str, i2, builder);
        }
        return builder.buildOrThrow();
    }

    /*  WARNING: Removed duplicated region for block: B:22:0x0052  */
    /*  WARNING: Removed duplicated region for block: B:35:0x0065 A[EDGE_INSN: B:35:0x0065->B:27:0x0065 ?: BREAK  , SYNTHETIC] */
    ...
    private static int doParseTrieToBuilder(java.util.Deque<java.lang.CharSequence> r8, java.lang.CharSequence r9, int r10, com.google.common.collect.ImmutableMap.Builder<java.lang.String, com.google.thirdparty.publicsuffix.PublicSuffixType> r11) {
        ...
        L_0x0065:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.thirdparty.publicsuffix.TrieParser.doParseTrieToBuilder(java.util.Deque, java.lang.CharSequence, int, com.google.common.collect.ImmutableMapBuilder):int");
    }
