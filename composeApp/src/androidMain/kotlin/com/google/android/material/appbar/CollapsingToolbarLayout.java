...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.CollapsingToolbarLayout, i2, i3);
        ...
        int i10 = R.styleable.CollapsingToolbarLayout_titleTextEllipsize;
        if (typedArrayObtainStyledAttributes.hasValue(i10)) {
            setTitleEllipsize(convertEllipsizeToTruncateAt(typedArrayObtainStyledAttributes.getInt(i10, -1)));
        }
        int i11 = R.styleable.CollapsingToolbarLayout_expandedTitleTextColor;
        if (typedArrayObtainStyledAttributes.hasValue(i11)) {
            collapsingTextHelper.setExpandedTextColor(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i11));
        }
        int i12 = R.styleable.CollapsingToolbarLayout_collapsedTitleTextColor;
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            collapsingTextHelper.setCollapsedTextColor(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, i12));
        }
        ...
        int i13 = R.styleable.CollapsingToolbarLayout_maxLines;
        if (typedArrayObtainStyledAttributes.hasValue(i13)) {
            collapsingTextHelper.setMaxLines(typedArrayObtainStyledAttributes.getInt(i13, 1));
        }
        int i14 = R.styleable.CollapsingToolbarLayout_titlePositionInterpolator;
        if (typedArrayObtainStyledAttributes.hasValue(i14)) {
            collapsingTextHelper.setPositionInterpolator(android.view.animation.AnimationUtils.loadInterpolator(context2, typedArrayObtainStyledAttributes.getResourceId(i14, 0)));
        }
        ...
        int i15 = R.attr.motionEasingStandardInterpolator;
        this.scrimAnimationFadeInInterpolator = MotionUtils.resolveThemeInterpolator(context2, i15, AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR);
        this.scrimAnimationFadeOutInterpolator = MotionUtils.resolveThemeInterpolator(context2, i15, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
    ...
    private void ensureToolbar() {
        if (this.refreshToolbar) {
            ...
            if (i2 != -1) {
                ViewGroup viewGroup2 = findViewById(i2);
    ...
    protected void drawableStateChanged() {
        ...
        boolean state = drawable != null && drawable.isStateful() && drawable.setState(drawableState);
        Drawable drawable2 = this.contentScrim;
    ...
    public void setScrimVisibleHeightTrigger(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
    ...
    public void setScrimAnimationDuration(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) long j2) {
