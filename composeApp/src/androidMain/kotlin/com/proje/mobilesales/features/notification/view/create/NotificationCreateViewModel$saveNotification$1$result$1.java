...
@DebugMetadata(m23c = "com.proje.mobilesales.features.notification.view.create.NotificationCreateViewModelsaveNotification1result1", m22f = "NotificationCreateViewModel.kt", m21l = {}, m20m = "invokeSuspend")

public final class NotificationCreateViewModelsaveNotification1result1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BaseSelectResult<Object>>, Object> {
    ...
    public NotificationCreateViewModelsaveNotification1result1(NotificationCreateViewModel notificationCreateViewModel, NotificationModel notificationModel, List<NotifiedUserModel> list, Continuation<? super NotificationCreateViewModelsaveNotification1result1> continuation) {
