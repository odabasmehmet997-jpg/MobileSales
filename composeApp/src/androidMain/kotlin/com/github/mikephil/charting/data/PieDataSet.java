...
public class PieDataSet extends com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.Entry> implements IPieDataSet {
    ...
    public PieDataSet(List<com.github.mikephil.charting.data.Entry> list, String str) {
        super (list, str);
        final ValuePosition valuePosition = ValuePosition.INSIDE_SLICE;
    ...
    public DataSet<Entry> copy() {
        ...
        PieDataSet pieDataSet = new PieDataSet (arrayList, this.getLabel());
