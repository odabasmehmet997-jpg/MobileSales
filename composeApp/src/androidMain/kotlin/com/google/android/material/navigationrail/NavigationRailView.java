...
public class NavigationRailView extends NavigationBarView {
    ...
    public NavigationRailView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i3) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.NavigationRailView, i2, i3);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i5)) {
            this.paddingTopSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(i5, false));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i6)) {
            this.paddingBottomSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(i6, false));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i7)) {
            this.paddingStartSystemWindowInsets = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(i7, false));
        }
    ...
    public void addHeaderView(@LayoutRes int i2) {
        addHeaderView(LayoutInflater.from(getContext()).inflate(i2, this, false));
    }
