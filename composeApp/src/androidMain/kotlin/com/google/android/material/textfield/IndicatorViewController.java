...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(context, i2, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
        ...
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context, i2, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        int i3 = R.attr.motionEasingEmphasizedDecelerateInterpolator;
        this.captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, i3, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        TimeInterpolator timeInterpolator = AnimationUtils.LINEAR_INTERPOLATOR;
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, i3, timeInterpolator);
    ...
    private ObjectAnimator createCaptionOpacityAnimator(TextView textView, boolean z) {
        ...
        if (z) {
            i2 = this.captionFadeInAnimationDuration;
        } else {
            i2 = this.captionFadeOutAnimationDuration;
        }
    ...
    private boolean isCaptionStateError(int i2) {
        return i2 == 1 && this.errorView != null && !TextUtils.isEmpty(this.errorText);
    }
