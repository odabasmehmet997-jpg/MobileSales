...
final class MaybeFlatMapIterableFlowableFlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements MaybeObserver<T> {
    ...
    MaybeFlatMapIterableFlowableFlatMapIterableObserver(Subscriber<? super R> subscriber, Function<? super T, ? extends Iterable<? extends R>> function) {
