...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public /* synthetic */ void lambda$new$0(String str) {
        ...
        textInputLayout.setError(context.getString(R.string.mtrl_picker_invalid_format) + SqlLiteVariable._NEW_LINE + String.format(context.getString(R.string.mtrl_picker_invalid_format_use), sanitizeDateString(str)) + SqlLiteVariable._NEW_LINE + String.format(context.getString(R.string.mtrl_picker_invalid_format_example), sanitizeDateString(dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis())))));
        onInvalidDate();
    }
    ...
    private Runnable createRangeErrorCallback(final long j2) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public void run() {
                this.f$0.lambda$createRangeErrorCallback$1(j2);
            }
        };
    }
