...
public interface VisibilityChecker<T extends VisibilityChecker<T>> {
    ...
    class Std implements VisibilityChecker<Std>, Serializable {
        ...
        public Std m646with(JsonAutoDetect.Visibility visibility) {
            if (visibility == JsonAutoDetect.Visibility.DEFAULT) {
                return DEFAULT;
            }
        ...
        public Std withVisibility(PropertyAccessor propertyAccessor, JsonAutoDetect.Visibility visibility) {
            switch (C11631.SwitchMapcomfasterxmljacksonannotationPropertyAccessor[propertyAccessor.ordinal()]) {
                case 1:
    ...
    /* renamed from: com.fasterxml.jackson.databind.introspect.VisibilityChecker1 */
    /* synthetic */ class C11631 {
        static final /* synthetic */ int[] SwitchMapcomfasterxmljacksonannotationPropertyAccessor;

        static {
            int[] r0 = new int[PropertyAccessor.values().length];
            SwitchMapcomfasterxmljacksonannotationPropertyAccessor = r0;
            try {
                r0[PropertyAccessor.GETTER.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                SwitchMapcomfasterxmljacksonannotationPropertyAccessor[PropertyAccessor.SETTER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                SwitchMapcomfasterxmljacksonannotationPropertyAccessor[PropertyAccessor.CREATOR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                SwitchMapcomfasterxmljacksonannotationPropertyAccessor[PropertyAccessor.FIELD.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                SwitchMapcomfasterxmljacksonannotationPropertyAccessor[PropertyAccessor.IS_GETTER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                SwitchMapcomfasterxmljacksonannotationPropertyAccessor[PropertyAccessor.ALL.ordinal()] = 6;
