...
public class SubTypeValidator {
    ...
    protected Set<String> _cfgIllegalClassNames = SubTypeValidator.DEFAULT_NO_DESER_CLASS_NAMES;
    ...
    public void validateSubType(final DeserializationContext deserializationContext, final JavaType javaType, final BeanDescription beanDescription) throws JsonMappingException {
        ...
        if (!_cfgIllegalClassNames.contains(name)) {
            ...
            if (name.startsWith("org.springframework.")) {
                while (null != rawClass && Object.class != rawClass) {
                    final String simpleName = rawClass.getSimpleName();
