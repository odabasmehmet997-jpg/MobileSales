...
public final class AnnotationMap implements Annotations {
    private HashMap<Class<?>, Annotation> _annotations;

    public AnnotationMap() {
    }

    /* renamed from: of */
    public static AnnotationMap m175of(Class<?> cls, Annotation annotation) {
    ...
    private boolean _add(Annotation annotation) {
        if (this._annotations == null) {
