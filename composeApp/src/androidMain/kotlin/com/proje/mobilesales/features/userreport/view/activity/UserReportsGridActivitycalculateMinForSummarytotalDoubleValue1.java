...
public final class UserReportsGridActivitycalculateMinForSummarytotalDoubleValue1 extends Lambda implements Function1<GenericDataPrimitive, Double> {
    public static final UserReportsGridActivitycalculateMinForSummarytotalDoubleValue1 INSTANCE = new UserReportsGridActivitycalculateMinForSummarytotalDoubleValue1();
    UserReportsGridActivitycalculateMinForSummarytotalDoubleValue1() {
        super(1);
    }
