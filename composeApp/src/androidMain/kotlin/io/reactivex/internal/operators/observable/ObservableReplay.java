...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements ResettableConnectable {
    ...
    public void resetIf(Disposable disposable) {
        LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.current, (ReplayObserver) disposable, null);
    }

    @Override // io.reactivex.Observable
    protected void subscribeActual(Observer<? super T> observer) {
        this.onSubscribe.subscribe(new Observer<DataResponse<ItemSlip>>() {
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (null != replayObserver && !replayObserver.isDisposed()) {
                break;
            }
            ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
            if (LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.current, replayObserver, replayObserver2)) {
    ...
    static final class ReplayObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        boolean add(InnerDisposable<T> innerDisposable) {
            ...
            } while (!LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.observers, innerDisposableArr, innerDisposableArr2));
            return true;
        }
    ...
    static final class UnboundedReplayBuffer<T> extends ArrayList<Object> implements ReplayBuffer<T> {
        ...
        public void replay(InnerDisposable<T> innerDisposable) {
            if (0 != innerDisposable.getAndIncrement ()) {
                return;
            }
    ...
    static abstract class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
        ...
        public final void replay(InnerDisposable<T> innerDisposable) {
            ...
            int i2 = 1;
            do {
                Node node = innerDisposable.index();
                if (null == node) {
                    node = getHead();
    ...
    static final class SizeAndTimeBoundReplayBuffer<T> extends BoundedReplayBuffer<T> {
        ...
        void truncateFinal() {
            ...
            while (true) {
                ...
                Node node4 = node;
                node = node3;
                if (null == node || 1 >= size || ((Timed) node.value).time() > now) {
                    break;
                }
                i2++;
                this.size--;
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public Disposable subscribe(Observer<DataResponse<ItemSlip>> observer) {
            ...
            while (true) {
                ...
                if (null != replayObserver) {
                    break;
                }
                ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
                if (LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.curr, null, replayObserver2)) {
                    replayObserver = replayObserver2;
                    break;
                }
            }
    ...
    static final class MulticastReplay<R, U> extends Observable<R> {
        ...
        protected void subscribeActual(Observer<? super R> observer) {
            try {
                ConnectableObservable connectableObservable = ObjectHelper.requireNonNull(this.connectableFactory.call(), "The connectableFactory returned a null ConnectableObservable");
                ObservableSource observableSource = ObjectHelper.requireNonNull(this.selector.apply(connectableObservable), "The selector returned a null ObservableSource");
