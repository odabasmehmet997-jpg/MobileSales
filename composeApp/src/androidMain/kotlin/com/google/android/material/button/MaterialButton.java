...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.MaterialButton, i2, i3);
    ...
    private void updateIconPosition(int i2, int i3) {
        ...
        if (isIconStart() || isIconEnd()) {
            ...
            int textLayoutWidth = ((((i2 - getTextLayoutWidth()) - ViewCompat.getPaddingEnd(this)) - intrinsicWidth) - this.iconPadding) - ViewCompat.getPaddingStart(this);
