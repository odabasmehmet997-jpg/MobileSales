...
public record NotificationListAdapterViewHolderExternalSyntheticLambda0(Function1 f0,
                                                                           NotificationModel f1) implements View.OnClickListener {

    @Override // android.view.View.OnClickListener
    public void onClick(View view) {
        NotificationListAdapter.ViewHolder.bindlambda3lambda0(this.f0, this.f1, view);
    }
}
