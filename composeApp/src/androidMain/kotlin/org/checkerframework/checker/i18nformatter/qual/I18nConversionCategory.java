...
public enum I18nConversionCategory {
    ...
    static {
        final I18nConversionCategory i18nConversionCategory = DATE;
        final I18nConversionCategory i18nConversionCategory2 = NUMBER;
    ...
    public static I18nConversionCategory intersect(I18nConversionCategory i18nConversionCategory, I18nConversionCategory i18nConversionCategory2) {
        final I18nConversionCategory i18nConversionCategory3 = UNUSED;
        if (i18nConversionCategory3 == i18nConversionCategory) {
            return i18nConversionCategory2;
        }
        if (i18nConversionCategory3 == i18nConversionCategory2) {
            return i18nConversionCategory;
        }
        final I18nConversionCategory i18nConversionCategory4 = GENERAL;
        if (i18nConversionCategory4 == i18nConversionCategory) {
            return i18nConversionCategory2;
        }
        if (i18nConversionCategory4 == i18nConversionCategory2) {
            return i18nConversionCategory;
        }
