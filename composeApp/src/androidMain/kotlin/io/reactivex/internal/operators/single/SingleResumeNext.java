...
public final class SingleResumeNext<T> extends Single<T> {
    ...
    static final class ResumeMainSingleObserver<T> extends AtomicReference<Disposable> implements SingleObserver<T>, Disposable {
        ...
        public void onError(Throwable th) {
            try {
                ObjectHelper.requireNonNull(this.nextFunction.apply(th), "The nextFunction returned a null SingleSource.").subscribe(new ResumeSingleObserver(this, this.downstream));
            } catch (Throwable th2) {
