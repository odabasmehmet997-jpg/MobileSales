...
final class ColorResourcesTableCreator {
    ...
    private static class ResTable {
        ...
        private final StringPoolChunk stringPool = new StringPoolChunk();
    ...
    private static class StringPoolChunk {
        ...
        StringPoolChunk(boolean z, String... strArr) {
            ...
            for (String str : strArr) {
                ...
                this.styledSpans.add(pairProcessString.second);
            }
            int size = 0;
            ...
            int i4 = length + i3;
            this.styledSpansStart = z2 ? size3 + i4 : 0;
            int i5 = size3 + i4 + (z2 ? size : 0);
            this.chunkSize = i5;
            this.header = new ResChunkHeader((short) 1, HEADER_SIZE, i5);
        }
