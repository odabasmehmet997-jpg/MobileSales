...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i2, i3);
        ...
        if (textAppearance != null) {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i4)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, i4));
            }
        }
    ...
    public void setRevealFraction(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f2) {
