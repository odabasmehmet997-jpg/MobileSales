...
final class zzp implements ServiceConnection, zzt {
    ...
    public void zzd(ServiceConnection serviceConnection, ServiceConnection serviceConnection2, String str) {
        this.zzb.put(serviceConnection, serviceConnection2);
    }

    public void zze(String str, @Nullable Executor executor) {
        this.zzc = 3;
    ...
    public void zzf(ServiceConnection serviceConnection, String str) {
    ...
    public boolean zzh(ServiceConnection serviceConnection) {
