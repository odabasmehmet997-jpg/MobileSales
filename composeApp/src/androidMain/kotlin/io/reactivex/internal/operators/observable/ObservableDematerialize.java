...
public final class ObservableDematerialize<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    public ObservableDematerialize(ObservableSource<T> observableSource, Function<? super T, Notification<R>> function) {
    ...
    static final class DematerializeObserver<T, R> implements Observer<T>, Disposable {
        ...
        DematerializeObserver(Observer<? super R> observer, Function<? super T, Notification<R>> function) {
        ...
        public void onNext(Object t) {
            if (this.done) {
                if (t instanceof Notification notification) {
            ...
            try {
                Notification notification2 = ObjectHelper.requireNonNull(this.selector.apply(t), "The selector returned a null Notification");
