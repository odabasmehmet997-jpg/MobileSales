...
public final class ObservableMapNotification<T, R> extends AbstractObservableWithUpstream<T, ObservableSource<? extends R>> {
    ...
    static final class MapNotificationObserver<T, R> implements Observer<T>, Disposable {
        ...
        public void onNext(Object t) {
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.onNextMapper.apply(t), "The onNext ObservableSource returned is null"));
            } catch (Throwable th) {
        ...
        public void onError(Throwable th) {
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.onErrorMapper.apply(th), "The onError ObservableSource returned is null"));
        ...
        public void onComplete() {
            try {
                this.downstream.onNext(ObjectHelper.requireNonNull(this.onCompleteSupplier.call(), "The onComplete ObservableSource returned is null"));
                this.downstream.onComplete();
            } catch (Throwable th) {
                Exceptions.throwIfFatal(th);
                this.downstream.onError(th);
