...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    ...
    private void ensureContainerAndBehavior() {
        if (this.container == null) {
            ...
            FrameLayout frameLayout2 = frameLayout.findViewById(getDialogId());
    ...
    private View wrapInSheet(int i2, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinatorLayout = getContainer().findViewById(COORDINATOR_LAYOUT_ID);
        if (i2 != 0 && view == null) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, ViewCompat.getLayoutDirection(this.sheet)) == 3) {
            i2 = R.style.Animation_Material3_SideSheetDialog_Left;
        } else {
            i2 = R.style.Animation_Material3_SideSheetDialog_Right;
        }
