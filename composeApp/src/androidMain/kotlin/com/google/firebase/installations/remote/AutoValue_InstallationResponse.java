...
final class AutoValue_InstallationResponse extends InstallationResponse {
    ...
    private AutoValue_InstallationResponse(@Nullable String str, @Nullable String str2, @Nullable String str3, @Nullable TokenResult tokenResult, @Nullable ResponseCode responseCode) {
        this.uri = str;
        this.fid = str2;
    ...
    static final class Builder extends InstallationResponse.Builder {
        ...
        @Override // com.google.firebase.installations.remote.InstallationResponse.Builder
        public InstallationResponse.Builder setResponseCode(ResponseCode responseCode) {
            this.responseCode = responseCode;
            return this;
        }
