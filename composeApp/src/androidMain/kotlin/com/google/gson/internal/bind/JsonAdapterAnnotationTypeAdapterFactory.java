...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapters.EnumTypeAdapter create(Gson gson, TypeToken<T> targetType) {
  ...
  private TypeAdapterFactory putFactoryAndGetCurrent(Class<?> rawType, TypeAdapterFactory factory) {
    ...
    return null != existingFactory ? existingFactory : factory;
  }
  ...
  TypeAdapter<?> getTypeAdapter(
    ...
    if (instance instanceof TypeAdapter) {
      ...
      @SuppressWarnings({"unchecked", "rawtypes"}) TypeAdapter<?> tempAdapter =
