...
public final class zzay extends zzaw {
    ...
    private static boolean zzc(zzap zzap, zzap zzap2) {
        if (zzap.getClass().equals(zzap2.getClass())) {
            ...
            if (zzap instanceof zzah) {
                return !Double.isNaN(zzap.zzh(this.zzd, 3, list).doubleValue()) && !Double.isNaN(zzap2.zzh(this.zzd, 3, list).doubleValue()) && zzap.zzh(this.zzd, 3, list).doubleValue() == zzap2.zzh(this.zzd, 3, list).doubleValue();
            }
            ...
            if (z && (zzap2 instanceof zzat)) {
                return zzc(zzap, new zzah(zzap2.zzh(this.zzd, 3, list)));
            }
            boolean z2 = zzap instanceof zzat;
            if (z2 && (zzap2 instanceof zzah)) {
                return zzc(new zzah(zzap.zzh(this.zzd, 3, list)), zzap2);
            }
            if (zzap instanceof zzaf) {
                return zzc(new zzah(zzap.zzh(this.zzd, 3, list)), zzap2);
            }
    ...
    /*  WARNING: Code restructure failed: missing block: B:18:0x0054, code lost:
    ...
    private static boolean zze(zzap zzap, zzap zzap2) {
        ...
        return ((zzap instanceof zzat && zzap2 instanceof zzat) || (!Double.isNaN(zzap.zzh(this.zzd, 3, list).doubleValue()) && !Double.isNaN(zzap2.zzh(this.zzd, 3, list).doubleValue()))) && !zzd(zzap2, zzap);
    }
