...
public class BottomSheetSearchDialogAdapter<T extends Searchable> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public BottomSheetSearchDialogAdapter(final Context context, @LayoutRes final int i2, final List<T> list) {
        this(context, i2, null, list);
    }

    public BottomSheetSearchDialogAdapter(final Context context, final AdapterViewBinder<T> adapterViewBinder, @LayoutRes final int i2, final List<T> list) {
        this(context, i2, adapterViewBinder, list);
    }

    public BottomSheetSearchDialogAdapter(final Context context, @LayoutRes final int i2, @Nullable final AdapterViewBinder<T> adapterViewBinder, final List<T> list) {
    ...
    public BottomSheetSearchDialogAdapter<T> setViewBinder(final AdapterViewBinder<T> adapterViewBinder) {
        mViewBinder = adapterViewBinder;
        return this;
    }
    ...
    private void initializeViews(T t, final ViewHolder viewHolder, int i2) {
        ...
        if (null != this.mSearchResultListener) {
            viewHolder.getBaseView().setOnClickListener(new View.OnClickListener() { // from class: com.proje.mobilesales.core.searchdialog.BottomSheetSearchDialogAdapter.1
    ...
    public void setSearchResultListener(final BottomSheetDialogSearchResultListener bottomSheetDialogSearchResultListener) {
        mSearchResultListener = bottomSheetDialogSearchResultListener;
    }
    ...
    public BottomSheetSearchDialogAdapter setSearchTag(final String str) {
        mSearchTag = str;
        return this;
    }
    ...
    public BottomSheetSearchDialogAdapter setHighlightPartsInCommon(final boolean z) {
        mHighlightPartsInCommon = z;
        return this;
    }

    public BottomSheetSearchDialogAdapter setSearchDialog(final BottomSheetDialog bottomSheetDialog) {
        mSearchDialog = bottomSheetDialog;
        return this;
    }
