...
final class zzao implements StreetViewLifecycleDelegate {
    ...
    public zzao(final Fragment fragment, final IStreetViewPanoramaFragmentDelegate iStreetViewPanoramaFragmentDelegate) {
    ...
    public void getStreetViewPanoramaAsync(final OnStreetViewPanoramaReadyCallback onStreetViewPanoramaReadyCallback) {
        try {
            zzb.getStreetViewPanoramaAsync(new zzan(this, onStreetViewPanoramaReadyCallback));
        } catch (final RemoteException e2) {
            throw new RuntimeRemoteException(e2);
        }
    }
