...
class ElementListUnionLabel extends TemplateLabel {
    ...
    public ElementListUnionLabel(final Contact contact, final ElementListUnion elementListUnion, final ElementList elementList, final Format format) throws Exception {
        label = new ElementListLabel(contact, elementList, format);
        extractor = new GroupExtractor(contact, elementListUnion, format);
    ...
    public Converter getConverter(final Context context) throws Exception {
        ...
        return new CompositeListUnion(context, extractor, expression, contact);
    }
