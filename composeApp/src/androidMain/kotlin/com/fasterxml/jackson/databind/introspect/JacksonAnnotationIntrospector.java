...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable {
    ...
    public String findEnumValue(Enum<?> r2) {
        ...
        String strValue;
        try {
            Field field = r2.getDeclaringClass().getField(r2.name());
            if (field != null && (jsonProperty = field.getAnnotation(JsonProperty.class)) != null && (strValue = jsonProperty.value()) != null) {
                if (!strValue.isEmpty()) {
                    return strValue;
                }
            }
    ...
    public String[] findEnumValues(Class<?> cls, Enum<?>[] enumArr, String[] strArr) {
        ...
        for (Field field : cls.getDeclaredFields()) {
            if (field.isEnumConstant() && (jsonProperty = field.getAnnotation(JsonProperty.class)) != null) {
        ...
        if (map != null) {
            ...
            for (int r1 = 0; r1 < length; r1++) {
                String str = (String) map.get(enumArr[r1].name());
                if (str != null) {
                    strArr[r1] = str;
                }
            }
    ...
    public void findEnumAliases(Class<?> cls, Enum<?>[] enumArr, String[][] strArr) {
        JsonAlias jsonAlias;
        for (Field field : cls.getDeclaredFields()) {
            if (field.isEnumConstant() && (jsonAlias = field.getAnnotation(JsonAlias.class)) != null) {
                String[] strArrValue = jsonAlias.value();
                if (strArrValue.length != 0) {
                    String name = field.getName();
                    int length = enumArr.length;
                    for (int r5 = 0; r5 < length; r5++) {
                        if (name.equals(enumArr[r5].name())) {
                            strArr[r5] = strArrValue;
                        }
                    }
                }
            }
    ...
    public PropertyName findRootName(AnnotatedClass annotatedClass) {
        JsonRootName jsonRootName = _findAnnotation(annotatedClass, JsonRootName.class);
    ...
    public Boolean isIgnorableType(AnnotatedClass annotatedClass) {
        JsonIgnoreType jsonIgnoreType = _findAnnotation(annotatedClass, JsonIgnoreType.class);
    ...
    public JsonIgnoreProperties.Value findPropertyIgnoralByName(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonIgnoreProperties jsonIgnoreProperties = _findAnnotation(annotated, JsonIgnoreProperties.class);
    ...
    public JsonIncludeProperties.Value findPropertyInclusionByName(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonIncludeProperties jsonIncludeProperties = _findAnnotation(annotated, JsonIncludeProperties.class);
    ...
    public Object findFilterId(Annotated annotated) {
        JsonFilter jsonFilter = _findAnnotation(annotated, JsonFilter.class);
        if (jsonFilter == null) {
            return null;
        }
    ...
    public Object findNamingStrategy(AnnotatedClass annotatedClass) {
        JsonNaming jsonNaming = _findAnnotation(annotatedClass, JsonNaming.class);
        if (jsonNaming == null) {
            return null;
        }
    ...
    public String findClassDescription(AnnotatedClass annotatedClass) {
        JsonClassDescription jsonClassDescription = _findAnnotation(annotatedClass, JsonClassDescription.class);
    ...
    public VisibilityChecker<?> findAutoDetectVisibility(AnnotatedClass annotatedClass, VisibilityChecker<?> visibilityChecker) {
        JsonAutoDetect jsonAutoDetect = _findAnnotation(annotatedClass, JsonAutoDetect.class);
    ...
    public List<PropertyName> findPropertyAliases(Annotated annotated) {
        JsonAlias jsonAlias = _findAnnotation(annotated, JsonAlias.class);
        if (jsonAlias == null) {
            return null;
        }
        String[] strArrValue = jsonAlias.value();
    ...
    public Boolean hasRequiredMarker(AnnotatedMember annotatedMember) {
        JsonProperty jsonProperty = _findAnnotation(annotatedMember, JsonProperty.class);
    ...
    public JsonProperty.Access findPropertyAccess(Annotated annotated) {
        JsonProperty jsonProperty = _findAnnotation(annotated, JsonProperty.class);
        if (jsonProperty != null) {
    ...
    public String findPropertyDescription(Annotated annotated) {
        JsonPropertyDescription jsonPropertyDescription = _findAnnotation(annotated, JsonPropertyDescription.class);
    ...
    public Integer findPropertyIndex(Annotated annotated) {
        int r1;
        JsonProperty jsonProperty = _findAnnotation(annotated, JsonProperty.class);
        if (jsonProperty == null || (r1 = jsonProperty.index()) == -1) {
            return null;
        }
    ...
    public JsonFormat.Value findFormat(Annotated annotated) {
        JsonFormat jsonFormat = _findAnnotation(annotated, JsonFormat.class);
        if (jsonFormat == null) {
            return null;
        }
    ...
    public ReferenceProperty findReferenceType(AnnotatedMember annotatedMember) {
        JsonManagedReference jsonManagedReference = _findAnnotation(annotatedMember, JsonManagedReference.class);
        if (jsonManagedReference != null) {
            return ReferenceProperty.managed(jsonManagedReference.value());
        }
        JsonBackReference jsonBackReference = _findAnnotation(annotatedMember, JsonBackReference.class);
    ...
    public NameTransformer findUnwrappingNameTransformer(AnnotatedMember annotatedMember) {
        JsonUnwrapped jsonUnwrapped = _findAnnotation(annotatedMember, JsonUnwrapped.class);
    ...
    public JacksonInject.Value findInjectableValue(AnnotatedMember annotatedMember) {
        String name;
        JacksonInject jacksonInject = _findAnnotation(annotatedMember, JacksonInject.class);
    ...
    public Class<?>[] findViews(Annotated annotated) {
        JsonView jsonView = _findAnnotation(annotated, JsonView.class);
        if (jsonView == null) {
            return null;
        }
    ...
    public List<NamedType> findSubtypes(Annotated annotated) {
        JsonSubTypes jsonSubTypes = _findAnnotation(annotated, JsonSubTypes.class);
    ...
    public String findTypeName(AnnotatedClass annotatedClass) {
        JsonTypeName jsonTypeName = _findAnnotation(annotatedClass, JsonTypeName.class);
    ...
    public ObjectIdInfo findObjectIdInfo(Annotated annotated) {
        JsonIdentityInfo jsonIdentityInfo = _findAnnotation(annotated, JsonIdentityInfo.class);
        if (jsonIdentityInfo == null || jsonIdentityInfo.generator() == ObjectIdGeneratorsNone.class) {
            return null;
        }
    ...
    public ObjectIdInfo findObjectReferenceInfo(Annotated annotated, ObjectIdInfo objectIdInfo) {
        JsonIdentityReference jsonIdentityReference = _findAnnotation(annotated, JsonIdentityReference.class);
    ...
    public Object findSerializer(Annotated annotated) {
        ...
        JsonSerialize jsonSerialize = _findAnnotation(annotated, JsonSerialize.class);
        if (jsonSerialize != null && (clsUsing = jsonSerialize.using()) != JsonSerializer.None.class) {
            return clsUsing;
        }
        JsonRawValue jsonRawValue = _findAnnotation(annotated, JsonRawValue.class);
    ...
    public JsonInclude.Value findPropertyInclusion(Annotated annotated) {
        JsonInclude jsonInclude = _findAnnotation(annotated, JsonInclude.class);
    ...
    private JsonInclude.Value _refinePropertyInclusion(Annotated annotated, JsonInclude.Value value) {
        ...
        if (jsonSerialize != null) {
            int r1 = C11551.f801xfdbfedae[jsonSerialize.include().ordinal()];
            if (r1 == 1) {
    ...
    /* renamed from: com.fasterxml.jackson.databind.introspect.JacksonAnnotationIntrospector1 */
    static /* synthetic */ class C11551 {

        /* renamed from: SwitchMapcomfasterxmljacksondatabindannotationJsonSerializeInclusion */
        static final /* synthetic */ int[] f801xfdbfedae;
        ...
        static {
            ...
            try {
                f801xfdbfedae[JsonSerialize.Inclusion.NON_NULL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f801xfdbfedae[JsonSerialize.Inclusion.NON_DEFAULT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f801xfdbfedae[JsonSerialize.Inclusion.NON_EMPTY.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f801xfdbfedae[JsonSerialize.Inclusion.DEFAULT_INCLUSION.ordinal()] = 5;
    ...
    public Object findSerializationContentConverter(AnnotatedMember annotatedMember) {
        JsonSerialize jsonSerialize = _findAnnotation(annotatedMember, JsonSerialize.class);
        if (jsonSerialize == null) {
            return null;
        }
    ...
    public JavaType refineSerializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (cls_classIfExplicit != null) if (javaType.hasRawClass(cls_classIfExplicit)) {
            ...
            try {
                if (cls_classIfExplicit.isAssignableFrom(rawClass)) {
                    ...
                    throw new JsonMappingException(null, String.format("Cannot refine serialization type %s into %s; types not related", javaType, cls_classIfExplicit.getName()));
                }
            } catch (IllegalArgumentException e2) {
                throw new JsonMappingException(null, String.format("Failed to widen type %s with annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit.getName(), annotated.getName(), e2.getMessage()), e2);
            }
        }
                ...
                if (keyType.hasRawClass(cls_classIfExplicit2)) {
                    ...
                    try {
                        if (cls_classIfExplicit2.isAssignableFrom(rawClass2)) {
                            ...
                            throw new JsonMappingException(null, String.format("Cannot refine serialization key type %s into %s; types not related", keyType, cls_classIfExplicit2.getName()));
                        }
                    } catch (IllegalArgumentException e3) {
                        throw new JsonMappingException(null, String.format("Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit2.getName(), annotated.getName(), e3.getMessage()), e3);
                    }
                }
        ...
        if (contentType.hasRawClass(cls_classIfExplicit3)) {
            ...
            try {
                if (cls_classIfExplicit3.isAssignableFrom(rawClass3)) {
                    ...
                    throw new JsonMappingException(null, String.format("Cannot refine serialization content type %s into %s; types not related", contentType, cls_classIfExplicit3.getName()));
                }
            } catch (IllegalArgumentException e4) {
                throw new JsonMappingException(null, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit3.getName(), annotated.getName(), e4.getMessage()), e4);
            }
        }
    ...
    public String[] findSerializationPropertyOrder(AnnotatedClass annotatedClass) {
        JsonPropertyOrder jsonPropertyOrder = _findAnnotation(annotatedClass, JsonPropertyOrder.class);
    ...
    private final Boolean _findSortAlpha(Annotated annotated) {
        JsonPropertyOrder jsonPropertyOrder = _findAnnotation(annotated, JsonPropertyOrder.class);
    ...
    public void findAndAddVirtualProperties(MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass, List<BeanPropertyWriter> list) {
        JsonAppend jsonAppend = _findAnnotation(annotatedClass, JsonAppend.class);
        if (jsonAppend == null) {
            return;
        }
        ...
        for (int r6 = 0; r6 < length; r6++) {
            ...
            BeanPropertyWriter beanPropertyWriter_constructVirtualProperty = _constructVirtualProperty(attrArrAttrs[r6], mapperConfig, annotatedClass, javaTypeConstructType);
            if (zPrepend) {
                list.add(r6, beanPropertyWriter_constructVirtualProperty);
            } else {
        ...
        for (int r4 = 0; r4 < length2; r4++) {
            BeanPropertyWriter beanPropertyWriter_constructVirtualProperty2 = _constructVirtualProperty(propArrProps[r4], mapperConfig, annotatedClass);
            if (zPrepend) {
                list.add(r4, beanPropertyWriter_constructVirtualProperty2);
            } else {
    ...
    protected BeanPropertyWriter _constructVirtualProperty(JsonAppend.Prop prop, MapperConfig<?> mapperConfig, AnnotatedClass annotatedClass) {
        ...
        if (virtualBeanPropertyWriterVirtualPropertyWriterInstance == null) {
            try {
                virtualBeanPropertyWriterVirtualPropertyWriterInstance = ClassUtil.createInstance(clsValue, mapperConfig.canOverrideAccessModifiers());
    ...
    public PropertyName findNameForSerialization(Annotated annotated) {
        boolean z;
        JsonGetter jsonGetter = _findAnnotation(annotated, JsonGetter.class);
        if (jsonGetter != null) {
    ...
    public Boolean hasAsKey(MapperConfig<?> mapperConfig, Annotated annotated) {
        JsonKey jsonKey = _findAnnotation(annotated, JsonKey.class);
        if (jsonKey == null) {
            return null;
        }
    ...
    public Boolean hasAsValue(Annotated annotated) {
        JsonValue jsonValue = _findAnnotation(annotated, JsonValue.class);
        if (jsonValue == null) {
            return null;
        }
    ...
    public Boolean hasAnyGetter(Annotated annotated) {
        JsonAnyGetter jsonAnyGetter = _findAnnotation(annotated, JsonAnyGetter.class);
    ...
    public boolean hasAsValueAnnotation(AnnotatedMethod annotatedMethod) {
        JsonValue jsonValue = _findAnnotation(annotatedMethod, JsonValue.class);
    ...
    public Object findDeserializer(Annotated annotated) {
        ...
        JsonDeserialize jsonDeserialize = _findAnnotation(annotated, JsonDeserialize.class);
    ...
    public Object findDeserializationContentConverter(AnnotatedMember annotatedMember) {
        JsonDeserialize jsonDeserialize = _findAnnotation(annotatedMember, JsonDeserialize.class);
        if (jsonDeserialize == null) {
            return null;
        }
    ...
    public JavaType refineDeserializationType(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (cls_classIfExplicit != null && !javaType.hasRawClass(cls_classIfExplicit) && !_primitiveAndWrapper(javaType, cls_classIfExplicit)) {
            try {
                ...
                throw new JsonMappingException(null, String.format("Failed to narrow type %s with annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit.getName(), annotated.getName(), e2.getMessage()), e2);
            }
        }
        if (javaType.isMapLikeType()) {
            JavaType keyType = javaType.getKeyType();
            ...
            if (cls_classIfExplicit2 != null && !_primitiveAndWrapper(keyType, cls_classIfExplicit2)) {
                try {
                    ...
                    throw new JsonMappingException(null, String.format("Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit2.getName(), annotated.getName(), e3.getMessage()), e3);
                }
            }
        }
        JavaType contentType = javaType.getContentType();
        ...
        try {
            ...
            throw new JsonMappingException(null, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", javaType, cls_classIfExplicit3.getName(), annotated.getName(), e4.getMessage()), e4);
        }
    }

    
    public Object findValueInstantiator(AnnotatedClass annotatedClass) {
        JsonValueInstantiator jsonValueInstantiator = _findAnnotation(annotatedClass, JsonValueInstantiator.class);
    ...
    public Class<?> findPOJOBuilder(AnnotatedClass annotatedClass) {
        JsonDeserialize jsonDeserialize = _findAnnotation(annotatedClass, JsonDeserialize.class);
        if (jsonDeserialize == null) {
            return null;
        }
    ...
    public JsonPOJOBuilder.Value findPOJOBuilderConfig(AnnotatedClass annotatedClass) {
        JsonPOJOBuilder jsonPOJOBuilder = _findAnnotation(annotatedClass, JsonPOJOBuilder.class);
        if (jsonPOJOBuilder == null) {
            return null;
        }
        return new JsonPOJOBuilder.Value();
    }
    public PropertyName findNameForDeserialization(Annotated annotated) {
        boolean z;
        JsonSetter jsonSetter = _findAnnotation(annotated, JsonSetter.class);
        if (jsonSetter != null) {
    ...
    public Boolean hasAnySetter(Annotated annotated) {
        JsonAnySetter jsonAnySetter = _findAnnotation(annotated, JsonAnySetter.class);
    ...
    public Boolean findMergeInfo(Annotated annotated) {
        JsonMerge jsonMerge = _findAnnotation(annotated, JsonMerge.class);
        if (jsonMerge == null) {
            return null;
        }
    ...
    public boolean hasCreatorAnnotation(Annotated annotated) {
        ...
        JsonCreator jsonCreator = _findAnnotation(annotated, JsonCreator.class);
        if (jsonCreator != null) {
    ...
    protected boolean _isIgnorable(Annotated annotated) {
        ...
        JsonIgnore jsonIgnore = _findAnnotation(annotated, JsonIgnore.class);
        if (jsonIgnore != null) {
    ...
    protected TypeResolverBuilder<?> _findTypeResolver(MapperConfig<?> mapperConfig, Annotated annotated, JavaType javaType) {
        ...
        JsonTypeInfo jsonTypeInfo = _findAnnotation(annotated, JsonTypeInfo.class);
        JsonTypeResolver jsonTypeResolver = _findAnnotation(annotated, JsonTypeResolver.class);
        if (jsonTypeResolver != null) {
            ...
            if (jsonTypeInfo.use() == JsonTypeInfo.EnumC1140id.NONE) {
                return _constructNoTypeResolverBuilder();
            }
            typeResolverBuilder_constructStdTypeResolverBuilder = _constructStdTypeResolverBuilder();
        }
        JsonTypeIdResolver jsonTypeIdResolver = _findAnnotation(annotated, JsonTypeIdResolver.class);
        ...
        JsonTypeInfo.EnumC1139As enumC1139AsInclude = jsonTypeInfo.include();
        if (enumC1139AsInclude == JsonTypeInfo.EnumC1139As.EXTERNAL_PROPERTY && (annotated instanceof AnnotatedClass)) {
            enumC1139AsInclude = JsonTypeInfo.EnumC1139As.PROPERTY;
        }
        TypeResolverBuilder typeResolverBuilderTypeProperty = typeResolverBuilderInit.inclusion(enumC1139AsInclude).typeProperty(jsonTypeInfo.property());
