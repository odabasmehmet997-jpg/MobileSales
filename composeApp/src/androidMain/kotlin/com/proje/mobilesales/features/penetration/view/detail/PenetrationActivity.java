...
public final class PenetrationActivity extends BaseFicheActivity implements ActionModeDelegate {
    ...
    private final int mAutoVisitId = 0;
    ...
    public PenetrationActivity() {
        ActivityResultLauncher<PickVisualMediaRequest> registerForActivityResult = registerForActivityResult(new ActivityResultContracts.PickVisualMedia(), new ActivityResultCallback() {
            public void onActivityResult(Object obj) {
                PenetrationActivity.photoPickerLauncherlambda5(PenetrationActivity.this, (Uri) obj);
            }
        });
    ...
    public Penetration getPenetration() {
     ...
     public void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            PenetrationLineRecyclerViewAdapter penetrationLineRecyclerViewAdapter = new PenetrationLineRecyclerViewAdapter(this, this, salesFicheMode);
            this.mAdapter = penetrationLineRecyclerViewAdapter;
            Intrinsics.checkNotNull(penetrationLineRecyclerViewAdapter);
            penetrationLineRecyclerViewAdapter.setCardViewEnabled(true);
            int i = this.mPenetrationRef;
            ...
            getPenetrationFiche(i, ficheMode);
        }
        initView();
    ...
    public void getPenetrationFiche(int i, FicheMode ficheMode) {
        ...
        this.viewModel.getPenetrationExam(i, new PenetrationRecyclerSalesFicheGet(this));
    } 
    public static void getPenetrationFichelambda0(PenetrationActivity penetrationActivity, DialogInterface dialogInterface) {
    ...
    public void onPenetrationGet(Penetration penetration, String str) {
        ...
        if (penetration != null) {
            ...
            if (ficheMode != null) {
                if (ficheMode == FicheMode.COPY && (i = this.mSavedPenetrationID) > 0) {
                    deletePenetration(i, 0);
                }
    ...
    public void deletePenetration(int i, int i2) {
        ...
        this.viewModel.getCheckRemoteWorkTimeControl(WorkTimeControlProcessType.Penetration, new CheckWorkTimeListener(this, i, i2));
    } 
    public static final class CheckWorkTimeListener implements ResponseListener<String> {
        ...
        public CheckWorkTimeListener(PenetrationActivity penetrationActivity, int i, int i2) {
    ...
    public void onDeleted(int i) {
        if (i == -1) {
            Toast.makeText(this, R.string.exp_27_database_fiche_delete_error, Toast.LENGTH_LONG).show();
        }
    }
        ...
        recyclerView3.addItemDecoration(new RecyclerView.ItemDecoration() {
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView4, RecyclerView.State state) {
                ...
                if (mAdapter.isCardViewEnabled()) {
                    ...
                    rect.set(i, this.verticalMargin, i, 0);
                    return;
                }
    ...
    private Unit getPenetrationListItems() {
        String str;
        if (getSalesFicheMode() != FicheMode.ANALYSE) {
            ...
            this.viewModel.getTableList(PenetrationDetail.class, "PNT_ID=?", new String[]{StringUtils.convertIntToString(this.mPenetrationId)}, null, null, str, new PenetrationLineResponseListener(this));
        }
    ...
    private String getPenetrationTitle() {
        ...
        try {
            try {
                ...
                Log.e(MobileSales.TAG, "getPenetrationTitle: ", e);
                return "";
            }
    ...
    private void cancelFicheDialog() {
        ...
        alertDialogBuilder.setTitle(R.string.str_cancel_penetration_fiche_title).setMessage(R.string.str_return_penetration_fiche_question).setPositiveButton(17039370, new DialogInterface.OnClickListener() { // from class: com.proje.mobilesales.features.penetration.view.detail.PenetrationActivityExternalSyntheticLambda0
            public void onClick(DialogInterface dialogInterface, int i) {
                PenetrationActivity.cancelFicheDialoglambda1(PenetrationActivity.this, dialogInterface, i);
            }
        }).setNegativeButton(17039360, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                PenetrationActivity.cancelFicheDialoglambda2(dialogInterface, i);
            }
        }).setNeutralButton(R.string.str_save, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                PenetrationActivity.cancelFicheDialoglambda3(PenetrationActivity.this, dialogInterface, i);
            }
        }).create().show();
    }
    public static  void cancelFicheDialoglambda1(PenetrationActivity penetrationActivity, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(penetrationActivity, "this0");
        Intrinsics.checkNotNullParameter(dialogInterface, "dialogInterface");
    ...
    public static void cancelFicheDialoglambda2(DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(dialogInterface, "dialogInterface");
        dialogInterface.dismiss();
    }
    public static void cancelFicheDialoglambda3(PenetrationActivity penetrationActivity, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(penetrationActivity, "this0");
        Intrinsics.checkNotNullParameter(dialogInterface, "dialogInterface");
        if (-3 == i) {
            dialogInterface.dismiss();
    ...
    public static abstract class PenetrationLineResponseListener implements ResponseListener<List<? extends PenetrationDetail>> {
        ...
        public   WeakReference<PenetrationActivity> getMPenetrationActivity() {
            return this.mPenetrationActivity;
        }

        public   void setMPenetrationActivity(WeakReference<PenetrationActivity> weakReference) {
    ...
    public static   void photoPickerLauncherlambda5(PenetrationActivity penetrationActivity, Uri uri) {
        Intrinsics.checkNotNullParameter(penetrationActivity, "this0");
        if (uri != null) {
    ...
    private   void onImageResult(Intent intent) {
        if (intent != null) {
            try {
                ...
                Intrinsics.checkNotNull(extras2);
                int i = extras2.getInt(IntentExtraName.EXTRAS_POSITON, -1);
                if (i != -1) {
                    PenetrationLineRecyclerViewAdapter penetrationLineRecyclerViewAdapter = this.mAdapter;
                    Intrinsics.checkNotNull(penetrationLineRecyclerViewAdapter);
                    List<PenetrationLine> penetrationLines = penetrationLineRecyclerViewAdapter.getPenetrationLines();
                    Intrinsics.checkNotNull(penetrationLines);
                    FicheImageProp image = penetrationLines.get(i).getImage();
    ...
    public static final class Companion {
        ...
        public   String getEXTRA_PENETRATION_ID() {
            return PenetrationActivity.EXTRA_PENETRATION_ID;
        }
        public   String getEXTRA_PENETRATION() {
            return PenetrationActivity.EXTRA_PENETRATION;
        }
    }
}
