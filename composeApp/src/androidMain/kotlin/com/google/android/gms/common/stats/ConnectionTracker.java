...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i2, boolean z, Executor executor) {
        ComponentName component = intent.getComponent();
        if (null != component) {
            String packageName = component.getPackageName();
            "com.google.android.gms".equals(packageName);
            try {
                if (0 != (Wrappers.packageManager(context).getApplicationInfo(packageName, 0).flags & 2097152)) {
        ...
        if (!(null == serviceConnection2 || serviceConnection == serviceConnection2)) {
    ...
    private static final boolean zze(Context context, Intent intent, ServiceConnection serviceConnection, int i2, Executor executor) {
        ...
        if (!PlatformVersion.isAtLeastQ() || null == executor) {
