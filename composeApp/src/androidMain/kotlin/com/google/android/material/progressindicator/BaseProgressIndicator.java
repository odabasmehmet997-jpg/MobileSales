...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    protected BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, i2, i3);
    ...
    protected synchronized void onMeasure(int i2, int i3) {
        ...
        try {
            ...
            if (currentDrawingDelegate.getPreferredWidth() < 0) {
                preferredWidth = View.getDefaultSize(getSuggestedMinimumWidth(), i2);
            } else {
    ...
    public void setIndicatorTrackGapSize(@Px int i2) {
        S s = this.spec;
        if (s.indicatorTrackGapSize != i2) {
            s.indicatorTrackGapSize = i2;
            s.validateSpec();
            invalidate();
        }
    }
