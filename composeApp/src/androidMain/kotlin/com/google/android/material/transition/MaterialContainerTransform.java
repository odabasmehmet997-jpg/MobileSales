...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f2) {
            ...
            float f7 = f5;
            float f8 = f6;
            FitModeResult fitModeResultEvaluate = this.fitModeEvaluator.evaluate(f2, Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.start)).floatValue(), Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scale.end)).floatValue(), this.startBounds.width(), this.startBounds.height(), this.endBounds.width(), this.endBounds.height());
            ...
            float fFloatValue = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scaleMask.start)).floatValue();
            float fFloatValue2 = Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.scaleMask.end)).floatValue();
            ...
            this.fadeModeResult = this.fadeModeEvaluator.evaluate(f2, Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.start)).floatValue(), Preconditions.checkNotNull(Float.valueOf(this.progressThresholds.fade.end)).floatValue(), 0.35f);
    ...
    public static class ProgressThresholds {
        ...
        public ProgressThresholds(@FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f2, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f3) {
            this.start = f2;
            this.end = f3;
        }
