...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public SideSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.sidesheet.SideSheetBehavior.1
            ...
            public boolean tryCaptureView(@NonNull View view, int i2) {
                return SideSheetBehavior.this.state != 1 && SideSheetBehavior.this.viewRef != null && SideSheetBehavior.this.viewRef.get() == view;
            }
    ...
    private void setSheetEdge(@NonNull V v, int i2) {
        setSheetEdge(GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) v.getLayoutParams()).gravity, i2) == 3 ? 1 : 0);
    }
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, int i2, int i3, int i4, int i5) {
        ...
        v.measure(getChildMeasureSpec(i2, coordinatorLayout.getPaddingLeft() + coordinatorLayout.getPaddingRight() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i3, -1, marginLayoutParams.width), getChildMeasureSpec(i4, coordinatorLayout.getPaddingTop() + coordinatorLayout.getPaddingBottom() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i5, -1, marginLayoutParams.height));
        return true;
    }
    ...
    private int calculateCurrentOffset(int i2, V v) {
        int i3 = this.state;
        if (i3 == 1 || i3 == 2) {
            return i2 - this.sheetDelegate.getOuterEdge(v);
        }
        if (i3 == 3) {
            return 0;
        }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull MotionEvent motionEvent) {
        ...
        return !this.ignoreEvents && (viewDragHelper = this.viewDragHelper) != null && viewDragHelper.shouldInterceptTouchEvent(motionEvent);
    }
    ...
    private boolean isSettling(View view, int i2, boolean z) {
        ...
        if (backEventCompatOnHandleBackInvoked == null || Build.VERSION.SDK_INT < 34) {
            ...
            this.sideContainerBackHelper.finishBackProgress(backEventCompatOnHandleBackInvoked, getGravityFromSheetEdge(), new AnimatorListenerAdapter() { // from class: com.google.android.material.sidesheet.SideSheetBehavior.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    SideSheetBehavior.this.viewRef.get().requestLayout();
                }
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.lambda$getCoplanarFinishAnimatorUpdateListener$1(marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }
    ...
    class StateSettlingTracker {
        ...
        void continueSettlingToState(int i2) {
            ...
            ViewCompat.postOnAnimation(SideSheetBehavior.this.viewRef.get(), this.continueSettlingRunnable);
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int i2) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda1
            ...
            public boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return this.f$0.lambda$createAccessibilityViewCommandForState$2(i2, view, commandArguments);
            }
        };
    }
