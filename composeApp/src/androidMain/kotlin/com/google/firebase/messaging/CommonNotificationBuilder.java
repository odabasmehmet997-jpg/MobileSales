...
public final class CommonNotificationBuilder {
    ...
    /*  WARN: Type inference failed for: r0v2, types: [int] */
    /*  WARN: Type inference failed for: r0v6 */
    /*  WARN: Type inference failed for: r0v7 */
    ...
    private static PendingIntent createMessagingPendingIntent(Context context, Intent intent) {
        return PendingIntent.getBroadcast(context, generatePendingIntentRequestCode(), new Intent(ACTION_MESSAGING_EVENT).setComponent(new ComponentName(context, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), getPendingIntentFlags(BasicMeasure.EXACTLY));
    }
