...
public final class ActivityChequeAndDeedFicheBinding implements ViewBinding {
    ...
    public static ActivityChequeAndDeedFicheBinding inflate(final LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }
    public static ActivityChequeAndDeedFicheBinding inflate(final LayoutInflater layoutInflater,  final ViewGroup viewGroup, final boolean z) {
        final View inflate = layoutInflater.inflate(R.layout.activity_cheque_and_deed_fiche, viewGroup, false);
        if (z) {
            viewGroup.addView(inflate);
        }
        return bind(inflate);
    }
    public static ActivityChequeAndDeedFicheBinding bind(final View view) {
        int i2 = R.id.appbar;
                                            ...
                                            if (null != textView) {
                                                ...
                                                if (null != textView2) {
                                                    ...
                                                    if (null != textView3) {
                                                        ...
                                                        if (null != viewPager) {
                                                            return new ActivityChequeAndDeedFicheBinding(coordinatorLayout, appBarLayout, coordinatorLayout, floatingActionButton, frameLayout, imageButton, linearLayout, linearLayout2, linearLayout3, tabLayout, toolbar, textView, textView2, textView3, viewPager);
                                                        }
                                                    }
                                                }
                                            }
