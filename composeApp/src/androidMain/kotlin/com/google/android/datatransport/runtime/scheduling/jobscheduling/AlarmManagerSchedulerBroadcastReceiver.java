...
public class AlarmManagerSchedulerBroadcastReceiver extends BroadcastReceiver {
    public static   void lambdaonReceive0() {
    }
    public void onReceive(Context context, Intent intent) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i2, () -> AlarmManagerSchedulerBroadcastReceiver.lambdaonReceive0());
    }
}
