...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public View inflateHeaderView(@LayoutRes int i2) {
        View viewInflate = this.layoutInflater.inflate(i2, this.headerLayout, false);
        ...
        private void setAccessibilityDelegate(View view, final int i2, final boolean z) {
            ViewCompat.setAccessibilityDelegate(view, new AccessibilityDelegateCompat() { // from class: com.google.android.material.internal.NavigationMenuPresenter.NavigationMenuAdapter.1
                ...
                public void onInitializeAccessibilityNodeInfo(@NonNull View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                    ...
                    accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(NavigationMenuAdapter.this.adjustItemPositionForA11yDelegate(i2), 1, 1, 1, z, view2.isSelected()));
                }
            });
        }
