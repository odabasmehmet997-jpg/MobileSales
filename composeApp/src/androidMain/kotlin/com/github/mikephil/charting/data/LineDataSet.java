...
public class LineDataSet extends LineRadarDataSet<com.github.mikephil.charting.data.Entry> implements ILineDataSet {
    ...
    public LineDataSet(List<com.github.mikephil.charting.data.Entry> list, String str) {
        super (list, str);
    ...
    public DataSet<Entry> copy() {
        ...
        LineDataSet lineDataSet = new LineDataSet (arrayList, this.getLabel());
    ...
    public boolean isDrawCubicEnabled() {
        return Mode.CUBIC_BEZIER == mMode;
    }
