...
public final class ObservableUsing<T, D> extends Observable<T> {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        try {
            ...
            try {
                ObjectHelper.requireNonNull(this.sourceSupplier.apply(call), "The sourceSupplier returned a null ObservableSource").subscribe(new Observer<DataResponse<ItemSlip>>() {
