...
final class ParallelRunOnRunOnSubscriber<T> extends ParallelRunOnBaseRunOnSubscriber<T> {
    private static final long serialVersionUID = 1075119423897941642L;
    final Subscriber<? super T> downstream;

    ParallelRunOnRunOnSubscriber(Subscriber<? super T> subscriber, int i2, SpscArrayQueue<T> spscArrayQueue, Scheduler.Worker worker) {
