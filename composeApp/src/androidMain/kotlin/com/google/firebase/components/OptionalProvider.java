...
class OptionalProvider<T> implements Provider<T>, Deferred<T> {
    ...
    private static final DeferredHandler<Object> NOOP_HANDLER = new DeferredHandler() { // from class: com.google.firebase.components.OptionalProvider$$ExternalSyntheticLambda0
    ...
    private OptionalProvider(DeferredHandler<T> deferredHandler, Provider<T> provider) {
    ...
    public void whenAvailable(@NonNull final DeferredHandler<T> deferredHandler) {
        Provider<T> provider;
        ...
        synchronized (this) {
            ...
            if (provider != provider4) {
                ...
                final DeferredHandler<T> deferredHandler2 = this.handler;
                this.handler = new DeferredHandler() { // from class: com.google.firebase.components.OptionalProvider$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.inject.Deferred.DeferredHandler
