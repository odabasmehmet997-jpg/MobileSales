...
public final class FragmentSalesListBinding implements ViewBinding {
    ...
    private FragmentSalesListBinding(final FrameLayout frameLayout, final EmptyListBinding emptyListBinding, final EmptySearchBinding emptySearchBinding, final RecyclerView recyclerView, final AppBarSwipeRefreshLayout appBarSwipeRefreshLayout) {
    ...
    public static FragmentSalesListBinding inflate(final LayoutInflater layoutInflater) {
        return FragmentSalesListBinding.inflate(layoutInflater, null, false);
    }

   
    public static FragmentSalesListBinding inflate(final LayoutInflater layoutInflater, @Nullable final ViewGroup viewGroup, final boolean z) {
        final View inflate = layoutInflater.inflate(R.layout.fragment_sales_list, viewGroup, false);
        if (z) {
            viewGroup.addView(inflate);
        }
        return FragmentSalesListBinding.bind(inflate);
    }

   
    public static FragmentSalesListBinding bind(final View view) {
        int i2 = R.id.empty;
            ...
            if (null != findChildViewById2) {
                ...
                if (null != recyclerView) {
                    ...
                    if (null != appBarSwipeRefreshLayout) {
                        return new FragmentSalesListBinding((FrameLayout) view, bind, bind2, recyclerView, appBarSwipeRefreshLayout);
                    }
                }
            }
        }
