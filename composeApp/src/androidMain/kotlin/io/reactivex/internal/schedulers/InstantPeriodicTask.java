...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    public void dispose() {
        ...
        if (null != andSet && andSet != futureTask) {
            andSet.cancel(this.runner != Thread.currentThread());
        }
        Future<?> andSet2 = this.rest.getAndSet(futureTask);
        if (null == andSet2 || andSet2 == futureTask) {
            return;
        }
    ...
    void setFirst(Future<?> future) {
        ...
        } while (!LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.first, future2, future));
    }
    ...
    void setRest(Future<?> future) {
        ...
        } while (!LifecycleKtExternalSyntheticBackportWithForwarding0.m(this.rest, future2, future));
    }
}
