...
public final class CreationContextFactory_Factory implements Factory<CreationContextFactory> {
    ...
    public static CreationContextFactory newInstance(Context context, Clock wallClock, Clock monotonicClock) {
        return new CreationContextFactory(context, wallClock, monotonicClock);
    }
}
