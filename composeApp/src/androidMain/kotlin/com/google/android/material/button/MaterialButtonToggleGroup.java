...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialButtonToggleGroup, i2, i3);
    ...
    private void checkInternal(@IdRes int i2, boolean z) {
        if (i2 == -1) {
