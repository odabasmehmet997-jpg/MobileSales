...
final class AutoValue_CrashlyticsReport_Session_Event extends CrashlyticsReport.Session.Event {
    ...
    private AutoValue_CrashlyticsReport_Session_Event(long j2, String str, Application application, Device device, @Nullable Log log) {
        this.timestamp = j2;
        this.type = str;
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((((int) (j2 ^ (j2 >>> 32))) ^ 1000003) * 1000003) ^ this.type.hashCode()) * 1000003) ^ this.app.hashCode()) * 1000003) ^ this.device.hashCode()) * 1000003;
        Log log = this.log;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Builder {
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Builder
        public CrashlyticsReport.Session.Event.Builder setApp(Application application) {
            if (application == null) {
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Builder
        public CrashlyticsReport.Session.Event.Builder setDevice(Device device) {
            if (device == null) {
        ...
        @Override // com.google.firebase.crashlytics.internal.model.CrashlyticsReport.Session.Event.Builder
        public CrashlyticsReport.Session.Event.Builder setLog(Log log) {
            this.log = log;
            return this;
        }
