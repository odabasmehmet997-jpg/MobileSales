...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public FloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.FloatingActionButton, i2, i3);
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return Preconditions.checkNotNull(getImpl().getShapeAppearance());
    }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState(Preconditions.checkNotNull(extendableSavedState.extendableStates.get(EXPANDABLE_WIDGET_HELPER_KEY)));
    }
