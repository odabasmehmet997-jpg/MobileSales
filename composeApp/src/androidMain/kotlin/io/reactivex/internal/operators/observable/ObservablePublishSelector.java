...
public final class ObservablePublishSelector<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource observableSource = ObjectHelper.requireNonNull(this.selector.apply(create), "The selector returned a null ObservableSource");
    ...
    record SourceObserver<T, R>(PublishSubject<T> subject, AtomicReference<Disposable> target) implements Observer<T> {
