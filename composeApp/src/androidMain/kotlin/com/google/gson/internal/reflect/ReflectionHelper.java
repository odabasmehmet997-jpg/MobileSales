...
public enum ReflectionHelper {
  ...
  static {
    ...
    private static String getInaccessibleTroubleshootingSuffix(final Exception e) {
    // Class was added in Java 9, therefore cannot use instanceof
    if ("java.lang.reflect.InaccessibleObjectException".equals(e.getClass().getName())) {
      final String message = e.getMessage();
      final String troubleshootingId =
              null != message && message.contains("to module com.google.gson")
  ...
  public static void makeAccessible(final AccessibleObject object) throws JsonIOException {
    try {
      ...
      final String description = ReflectionHelper.getAccessibleObjectDescription(object, false);
      throw new JsonIOException(
          "Failed making "
              + description
              + " accessible; either increase its visibility"
              + " or write a custom TypeAdapter for its declaring type."
              + ReflectionHelper.getInaccessibleTroubleshootingSuffix(exception),
          exception);
    }
  }
  ...
  public static String getAccessibleObjectDescription(
          final AccessibleObject object, final boolean uppercaseFirstLetter) {
    String description;
    ...
    if (object instanceof Field) {
      ...
      description = "constructor '" + ReflectionHelper.constructorToString((Constructor<?>) object) + "'";
    } else {
  ...
  private static void appendExecutableParameters(
          final AccessibleObject executable, final StringBuilder stringBuilder) {
  ...
  public static boolean isAnonymousOrNonStaticLocal(final Class<?> clazz) {
  ...
  private static class RecordSupportedHelper extends RecordHelper {
    ...
    private RecordSupportedHelper() throws NoSuchMethodException, ClassNotFoundException {
      ...
      final Class<?> classRecordComponent = Class.forName("java.lang.reflect.RecordComponent");
    ...
    String[] getRecordComponentNames(final Class<?> raw) {
      try {
        final Object[] recordComponents = (Object[]) this.getRecordComponents.invoke(raw);
