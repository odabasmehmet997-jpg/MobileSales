...
final class RequestBuilder {
    ...
    private static void canonicalizeForPath(Buffer buffer, String str, int i2, int i3, boolean z) throws EOFException {
        Buffer buffer2 = null;
        while (i2 < i3) {
            ...
            if (!z || (iCodePointAt != 9 && iCodePointAt != 10 && iCodePointAt != 12 && iCodePointAt != 13)) {
                if (iCodePointAt < 32 || iCodePointAt >= 127 || PATH_SEGMENT_ALWAYS_ENCODE_SET.indexOf(iCodePointAt) != -1 || (!z && (iCodePointAt == 47 || iCodePointAt == 37))) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte(cArr[((b2 & 255) >> 4) & 15]);
                        buffer.writeByte(cArr[b2 & 15]);
                    }
                } else {
    ...
    <T> void addTag(Class<T> cls, Object t) {
        this.requestBuilder.tag(cls);
    }
    Request.Builder get() {
        ...
        if (contentTypeOverridingRequestBody == null) {
            ...
            if (builder2 != null) {
                ...
                if (builder3 != null) {
                    ...
                    contentTypeOverridingRequestBody = RequestBody.create(null, new byte[0]);
                }
            }
        }
